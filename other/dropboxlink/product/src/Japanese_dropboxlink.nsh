...
!ifdef MUI_INSTFILESPAGE
  ${LangFileString} MUI_TEXT_INSTALLING_TITLE "処理"
  ${LangFileString} MUI_TEXT_INSTALLING_SUBTITLE "処理を実行中です。しばらくお待ちください。"
  ${LangFileString} MUI_TEXT_FINISH_TITLE "処理の完了"
  ${LangFileString} MUI_TEXT_FINISH_SUBTITLE "処理は終了しました。"
...
!ifdef MUI_ABORTWARNING
  ${LangFileString} MUI_TEXT_ABORTWARNING "処理を中止しますか？"
!endif
